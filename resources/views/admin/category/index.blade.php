...
@section('contentAdmin')
   ...
   <div class="d-flex justify-content-between align-items-end mb-3">
     <form action="{{ route('category.index') }}" method="GET" class="d-flex mb-3" style="width: 400px">
      ...
      <div class="col-md-3">
      <form action="{{ route('category.index') }}" method="get" onchange="this.submit()">
              ...
              <tbody>
               @foreach ($categories as $cat)
                  <tr>
                      ...
                      <td>
                          <form method="POST" action="{{Route('category.destroy',$cat->id)}}" onsubmit="return confirm('Are you sure?')">
                            @csrf
                            @method('Delete')
